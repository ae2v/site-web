...
<template>
	...
	<header
		ref="headerRef"
		class="flex flex-col items-center justify-center gap-8 bg-background h-screen"
	>
		<h1 class="text-7xl font-bold font-display text-center">BDE de Vélizy</h1>
	...
	<main class="bg-black/30 text-white min-h-screen">
